...
export default function TopAlbum() {
  return (
    <div
      ...
      <TextTooDrunk className="text-[#ffb800] text-3xl lg:text-4xl xl:text-5xl">
        Current obsession
      </TextTooDrunk>
      <TextInter className="text-base lg:text-xl xl:text-2xl text-justify">
        Akhir-akhir ini (atau lebih tepatnya tujuh hari terakhir) lagi obsessed
        sama album-album yang ada disini:
      </TextInter>
      <div>
        <LastFm />
      </div>
